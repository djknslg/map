...
define config.name = _("Map Adventure Game")
...
define gui.about = _p("""
Map Adventure Game is a simple exploration game.

Click on different areas of the map to explore new locations.
Each area has its own story and events to discover.
...
define build.name = "MapAdventureGame"
...
define config.save_directory = "ditu-1757639544"
